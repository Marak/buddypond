...
desktop.app.settings.load = function loadsettings (params, next) {
  ...
  //  if (typeof desktop.settings.apps_installed === 'undefined') {
      let defaultApps = [ 
        ...
        { name: 'login', label: 'Login', icon: 'login', class: 'loginIcon loginShortcut', version: '4.20.69' },
        { name: 'logout', label: 'Logout', icon: 'login', class: 'loggedIn logoutShortcut', version: '4.20.69' },
        { placeholder: true },
        { placeholder: true },
        { placeholder: true },
        { placeholder: true }
